...
def main():
    ...
    try:
        ...
        # 将新图片存在新文件夹中，SD中最多保留50个文件夹，自动删除最老的
        dirs = get_numeric_dirs(SD_PATH)
    ...
    def connect_wifi(ssid, password, timeout=4):
    ...
    # 主网络失败后尝试备用网络
    wifi_connected = connect_wifi('CrownYou', '3141592653', timeout=3)
